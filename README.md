...
## 📋 معرفی
اپ **MSN-VPN** یک اپلیکیشن VPN اندرویدی متن‌باز، سبک و قدرتمنده که با هسته‌ی **Aether** (نوشته‌شده با Rust) کار می‌کنه. این برنامه رابط کاربری مدرن اندروید، تونل VPN/TUN نیتیو، انتخاب پروتکل، نمایش لحظه‌ای وضعیت اتصال و انتشار نسخه‌ها رو در خودش داره.
